...
| Crea un entorno colaborativo e inclusivo, establece metas, planifica tareas y cumple objetivos. |Axel Randall Ordoñez Ricaldi:<br> **Acciones TB1:** Definimos lineamientos claros en el área técnica del proyecto, con especial atención a la arquitectura del software. Apoyamos en la asignación de tareas dentro del equipo y nos aseguramos de que la información necesaria estuviera disponible para todos.<br><br> Brayan Roberto Ccarita Cruz:<br> **Acciones TB1:** Contribuimos en la organización de los componentes visuales del producto y en la optimización de la landing page. Además, participamos activamente en reuniones de control para verificar el progreso del equipo.<br><br> Fabrizio Martin Panta Castro:<br> **Acciones TB1:** Participamos en la definición de metas del proyecto, enfocados principalmente en el diseño UX/UI y en la elaboración de recursos gráficos. Nuestro aporte fue esencial para dar forma a las primeras versiones del frontend..<br><br> Jean Niels Arizabal Condori: <br> **Acciones TB1:** Definimos metas y plazos de entrega con el fin de llevar un control claro y ordenado del progreso del trabajo.<br><br> Yeira Shari Huaman Olivos:<br> **Acciones TB1:** Colaboramos en un entorno inclusivo al definir perfiles de usuarios y sus necesidades, establecimos metas claras para guiar el diseño UX/UI, planificamos tareas enfocadas en la interfaz web y la landing page, y contribuimos al cumplimiento de los objetivos del equipo con prototipos funcionales.<br><br>|**Conclusión grupal TB1:**<br>En el desarrollo de la TB1 trabajamos de manera coordinada, combinando tanto el enfoque técnico como el visual del proyecto. Establecimos lineamientos y plazos de entrega que nos permitieron mantener un control ordenado del avance, al mismo tiempo que organizamos tareas específicas para aprovechar las fortalezas de cada integrante.<br>Gracias a esta colaboración, logramos avances significativos en la arquitectura del software, la planificación del diseño UX/UI, la elaboración de recursos gráficos y la optimización de la landing page. Asimismo, la definición de perfiles de usuario y el trabajo inclusivo con prototipos funcionales fortalecieron la propuesta del equipo. En conjunto, este esfuerzo sentó bases sólidas para continuar con un desarrollo estructurado y orientado a los objetivos del proyecto.|
